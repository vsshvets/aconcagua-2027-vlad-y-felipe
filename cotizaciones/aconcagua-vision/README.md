...
Respondió **Sabrina Recchimuzzi** (área comercial, firma como «Oficina Plaza de Mulas») el **viernes 18 de septiembre de 2026** por email. Ofreció seguir por WhatsApp: **+54 9 2604 04-8220**. Web: [aconcaguavision.com](https://aconcaguavision.com/es/).

## ⚡ En una línea

**USD 2.830 por persona, y según el email con el permiso incluido. Pero la web de la empresa dice lo contrario.** Si el permiso está adentro, es la opción más barata que llegó por email; si no, son **USD 3.780 por persona**, lo mismo que Grajales. Hay que pedir la confirmación por escrito antes de pagar.

## La oferta

| | |
|---|---|
| **Paquete** | Básico (Standard) de 4 días |
| **Precio** | **USD 2.830 por persona**. Textual: *«El costo de este paquete es de U$D 2830. El costo del permiso está incluido.»* |
| **⚠️ Lo que dice su web** | Página de logística, temporada 2026-27: *«PERMISO — Gestión integral para obtener el permiso de ascenso con descuento (**no incluye el costo del permiso**)»* ([es](https://aconcaguavision.com/es/logistica/en-aconcagua), [en](https://aconcaguavision.com/logistics/in-aconcagua): *«permit fee not included»*). En la tabla comparativa la fila PERMISO dice «Incluido», pero se refiere a la gestión |
...
| **Reserva** | La web: *«Para confirmar la reserva, es necesario abonar el 50% del paquete elegido.»* Sabrina no mencionó la seña |
| **Permiso en preventa** | Lo compran *«siempre y cuando los servicios contratados sean con nosotros»*. Para comprarlo alcanza con datos personales y pasaporte |
| **Seguro** | Cualquiera que cubra **evacuación en helicóptero hasta 5.500 m**. El certificado se presenta antes de entrar al parque, no para la preventa |
...
- Duchas calientes, electricidad y wifi incluidos en el básico (Inka los deja fuera del básico).
- Opción de sumar servicios de altura por USD 600, o solo baños de altura por USD 150.
- Respondió todas las preguntas, en orden, y mandó fotos de sus campamentos.
...
- **Que el «permiso incluido» sea un error.** Su propia web dice que el costo del permiso no está incluido, y Grajales cotizó exactamente USD 2.830 **sin** permiso. Con el permiso adentro, su logística costaría USD 1.880, un 23-34 % menos que todas las demás. Presupuestar USD 3.780 hasta tener la confirmación escrita.
- **Solo 4 días cubiertos**, y el plan tiene unas 7 noches en campamentos base (2 en Confluencia y 5 en Plaza de Mulas). No dijo qué pasa con las otras 3 noches.
- **35 kg de mula por persona**, contra los ~40 kg que calculamos. No dio precio por kilo extra.
- **Seña del 50 %** según la web, antes del 30 de septiembre si se usa la preventa.
- Dice que el seguro recién se necesita antes de entrar al parque. Si el permiso es innominado, el parque pide los documentos (seguro incluido) hasta el **25 de octubre**. Hay que preguntar qué modalidad usan.
...
```text
Hola Sabrina, muchas gracias por la respuesta y las fotos! Antes de reservar necesitamos confirmar algunas cosas por escrito:
1. En tu email dice que los USD 2.830 por persona incluyen el costo del permiso de preventa (USD 950), pero en la web dice "no incluye el costo del permiso". Nos confirmas cuál es el total por persona que le pagamos a Aconcagua Visión, con el permiso de Horcones incluido, para Vlad (ucraniano) y Felipe (chileno)?
2. Nuestro plan es dormir 2 noches en Confluencia y unas 5 en Plaza de Mulas. Las noches que no cubre el paquete podemos quedarnos en nuestra carpa y cocinar nosotros, usando los baños? Tiene costo? Cuánto sale la versión de 7 días?
3. Llevamos unos 40 kg cada uno. Cuánto cuestan los 5 kg extra por persona, o una mula extra? Dónde entregamos las cargas?
4. El permiso lo compran nominado o innominado? Qué necesitan, hasta qué fecha, y hasta cuándo tenemos que mandar el seguro?
5. Cuánto es la seña, cómo se paga desde Chile (transferencia en USD?) y cuál es la política de cancelación? El precio se mantiene si pagamos el resto después del 30 de septiembre?
6. El traslado Penitentes - Horcones está incluido? El auto se puede dejar en Horcones unas dos semanas? Tiene costo?
7. Tenemos la membresía del American Alpine Club (cubre rescate a cualquier altura). Les sirve la carta de membresía?
```
...
<img src="adjuntos/WhatsApp-Image-2026-03-23-at-10.27.09.jpeg" alt="Campamento de Aconcagua Visión" width="480">

**Nido de Cóndores (Campamento 2)**

<img src="adjuntos/AV-Camp-II-Nido-de-Condores.jpeg" alt="Nido de Cóndores (Campamento 2)" width="480">

**Berlín (Campamento 3, Ruta Normal)**

<img src="adjuntos/Berlin-Camp-Camp-3-Normal-Route.jpeg" alt="Berlín (Campamento 3, Ruta Normal)" width="480">
